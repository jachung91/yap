...
abstract contract KIP17URIStorage is KIP17 {
    ...
    function _changeTokenURI(uint256 tokenId, string memory _tokenURI) internal virtual {
        require(_exists(tokenId), "KIP17URIStorage: URI change of nonexistent token");
        _tokenURIs[tokenId] = _tokenURI;
    }
}
